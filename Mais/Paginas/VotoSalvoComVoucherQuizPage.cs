...
namespace Mais
{
    public class VotoSalvoComVoucherQuizPage  : ContentPage
    {
        Pergunta pergunta;
...
//                    btnCompartilhar.IsVisible = false;
        ...
        public VotoSalvoComVoucherQuizPage(Pergunta p)
        {
            this.pergunta = p;
            ...
            var sucesso = new Label
            {
                ...
                Text = p.correta ? "Parabéns, certa resposta! Você ganhou um voucher promocional! Confira o seu e-mail." :
            ...
            btnCompartilhar.Clicked += async (sender, e) =>
            {
                try
                {
                    ...
                    var msg = String.Format("Eu respondi ao quiz {0}"
