...
namespace Mais
{
    public class EnqueteMensagemView : ContentView
    {
        ...
        public EnqueteMensagemView(Enquete enquete)
        {
            ...
            var overlay = new StackLayout { BackgroundColor = Colors._defaultColorFromHex, InputTransparent = true };

            AbsoluteLayout.SetLayoutFlags(overlay, AbsoluteLayoutFlags.All);
            AbsoluteLayout.SetLayoutBounds(overlay, new Rectangle(1, 0, 1, 1));
            ...
            contanierLayout.Children.Add(overlay);
...
//                frameSeta.GestureRecognizers.Add(frame_Click_iOS);
            ...
            AbsoluteLayout.SetLayoutFlags(contanierLayout, AbsoluteLayoutFlags.All);
            AbsoluteLayout.SetLayoutBounds(contanierLayout, new Rectangle(0, 1, 1, 1));
