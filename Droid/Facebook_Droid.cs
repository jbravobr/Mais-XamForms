...
[assembly: ExportRenderer(typeof(CadastroComFacebook), typeof(FacebookLoginRenderer_Droid))]
				...
				if (eventArgs.IsAuthenticated)
				{
					...
					using (client)
					{
						...
						if (result.IsSuccessStatusCode)
						{
							...
							MessagingCenter.Send<CadastroComFacebook>((CadastroComFacebook)e.NewElement, "CadastrouComFacebook");
							return;
						}
					}
				}
